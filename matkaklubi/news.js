...
function valjastaUudis(uudis) {
  let valjund = `
  <div class="uudise_container col-4"> 
    <img class="pildid" src="${uudis.pildidUrl}">
      <h2 class="tiitel">${uudis.tiitel}<h2/>
      <div class="sisu">${uudis.sisu}<div/>
      <h3 class="autor">${uudis.autor}<h3/>
  <div/>
